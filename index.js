...
const EncoderV1 = exports.EncoderV1 = exports.Encoder = require('./lib/v1/encoder');
const DecoderV1 = exports.DecoderV1 = exports.Decoder = require('./lib/v1/decoder');

const EncoderV2 = exports.EncoderV2 = require('./lib/v2/encoder');
const DecoderV2 = exports.DecoderV2 = require('./lib/v2/decoder');
