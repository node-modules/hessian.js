...
describe('object.test.js', function() {
  describe('v1.0', function() {
    ...
    it('should write null for property like: { a: { "$class": "yyy.yyy", "$": null } }', function() {
      ...
      const rightBuf = Buffer.from('4d7400077878782e787878530001614e7a', 'hex');
    ...
    it('should write object for property like: { a: { "$class": "yyy.yyy", "$": {} } }', function() {
      ...
      const rightBuf = Buffer.from('4d7400077878782e787878530001614d7400077979792e7979797a7a', 'hex');
    ...
    it('should decode and encode ConnectionRequest', function() {
      const javabuf = utils.bytes('v1/object/ConnectionRequest');
      const connreq = hessian.decode(javabuf, '1.0', true);
      ...
      hessian.encode(connreq, '1.0');
      const jsbuf2 = hessian.encode(jsconnreq, '1.0');
      ...
      const jsbuf2Again = hessian.encode(jsconnreq, '1.0');
    ...
    it('should write "{$class: "hessian.test.demo.Car", $: {a: 1}}"', function() {
      ...
      const buf = hessian.encode(obj, '1.0');
      assert(buf[0] === 0x4d); // 'M'
    ...
    it('should read and write one car list', function() {
      ...
      const cars = hessian.decode(utils.bytes('v1/map/one_car_list'), '1.0', true);
    ...
    it('should read and write two car list', function() {
      ...
      const cars = hessian.decode(utils.bytes('v1/map/two_car_list'), '1.0', true);
      assert.deepEqual(cars, {
        $class: 'java.util.ArrayList',
        $: [{
          $class: 'hessian.demo.Car',
      ...
      const buf = hessian.encode(cars, '1.0');
    ...
    it('should read and write many cars', function() {
      ...
      const cars = hessian.decode(utils.bytes('v1/map/car_list'), '1.0', true);
      assert.deepEqual(cars, {
        $class: 'java.util.ArrayList',
        $: [{
          $class: 'hessian.demo.Car',
    ...
    describe('java.util.concurrent.atomic.AtomicLong', function() {
      it('should read and write', function() {
        let javabuf = utils.bytes('v1/object/AtomicLong0');
        let a0 = hessian.decode(javabuf);
        assert.deepEqual(a0, { value: 0 });
        a0 = hessian.decode(javabuf, true);
        assert.deepEqual(a0, {
        ...
        let a1 = hessian.decode(javabuf);
        assert.deepEqual(a1, { value: 1 });
        a1 = hessian.decode(javabuf, true);
        assert.deepEqual(a1, {
          $class: 'java.util.concurrent.atomic.AtomicLong',
          $: {
            value: {
  ...
  describe('map key object', function() {
    ...
    it('enum should use name v1', function() {
      ...
      const obj = new Map();
      obj.set(key, 'hello');
      const buf = hessian.encode(obj);
      const rs = hessian.decode(buf);
